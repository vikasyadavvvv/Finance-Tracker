...
import { FaMoneyBillWave, FaLock, FaEnvelope, FaSignInAlt } from "react-icons/fa";
...
export default function Login({ setAuth }) {
  ...
  try {
    ...
    localStorage.setItem("userEmail", form.email); // Store the email
    setAuth(true);
    navigate("/dashboard");
  } catch (err) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-emerald-50 to-amber-50 p-4">
      ...
      >
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-gray-600 text-sm">Manage your finances securely</p>
        </div>
